...
const PiggyBankIcon = ({
  ...
  return (
    <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="piggy-bank" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" onClick={onClickFunc} style={isMobileNavOpen ? { color: '#38b875' } : null}>
