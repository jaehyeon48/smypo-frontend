...
const DividendIcon = () => {
  return (
    <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="chart-pie-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
